...
module.exports = function(Chart) {
	...
	helpers.getAngleFromPoint = function(centrePoint, anglePoint) {
		var anceFromXCenter = anglePoint.x - centrePoint.x,
			...
			radialanceFromCenter = Math.sqrt(anceFromXCenter * anceFromXCenter + anceFromYCenter * anceFromYCenter);
...
module.exports = function(Chart) {
	...
	function drawPointLabels(scale) {
		...
		var outerance = scale.getanceFromCenterForValue(opts.reverse ? scale.min : scale.max);
