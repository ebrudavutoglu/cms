...
ZeroClipboard_TableTools.Client.prototype = {
	...
	getHTML: function(width, height) {
		...
		if (navigator.userAgent.match(/MSIE/)) {
			...
			html += '<embed id="'+this.movieId+'" src="<?php echo base_url('assets'); ?>'+ZeroClipboard_TableTools.moviePath+'" loop="false" menu="false" quality="best" bgcolor="#ffffff" width="'+width+'" height="'+height+'" name="'+this.movieId+'" align="middle" allowScriptAccess="always" allowFullScreen="false" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" flashvars="'+flashvars+'" wmode="transparent" />';
		}
		return html;
	},
